    ...
    <div className="flex flex-col h-[calc(100vh-8rem)] md:h-[calc(100vh-4rem)] animate-fade-in">
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-lg font-bold text-foreground">AI Troubleshooter</h2>
            <p className="text-[11px] text-muted-foreground">Enter fault code or describe the problem</p>
          </div>
        </div>
        {messages.length > 0 && (
          <button onClick={handleClear} className="p-2 rounded-lg text-muted-foreground hover:bg-secondary transition-colors">
          ...
          <div className="space-y-4">
            <div className="railway-gradient rounded-2xl p-5">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm font-semibold text-primary-foreground">Quick Troubleshoot</span>
              </div>
              <p className="text-primary-foreground/70 text-xs">
                Enter a fault code, describe symptoms, or tap a quick option below
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-2">
              {quickPrompts.map((qp) => (
                <button
                  ...
                  className="stat-card p-3 text-left group"
                >
            ...
            <p className="text-center text-[11px] text-muted-foreground pt-2">
              💡 You can also describe symptoms like "burning smell from motor" or "brakes not releasing"
            </p>
          </div>
        ) : (
          messages.map((msg, i) => (
      ...
      <div className="border-t border-border pt-3">
        ...
        >
          <input
            ...
            placeholder="Enter fault code or describe issue..."
            disabled={isLoading}
          ...
          <button
            ...
            className="h-11 w-11 rounded-xl bg-primary text-primary-foreground flex items-center justify-center disabled:opacity-50 transition-colors shrink-0"
          >
